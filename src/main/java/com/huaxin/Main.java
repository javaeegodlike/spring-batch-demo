...
import com.huaxin.mapper.HelloLineMapper;
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //创建writer
        FlatFileItemWriter<DeviceCommand> flatFileItemWriter = new FlatFileItemWriter<DeviceCommand>();
        ...
        Step step = stepBuilderFactory.get("step")
                .<DeviceCommand, DeviceCommand>chunk(1) //数组块为1
                .reader(flatFileItemReader)  //读操作
                .processor(helloProcessor)   //处理操作
